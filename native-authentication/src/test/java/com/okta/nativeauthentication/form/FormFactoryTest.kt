...
internal class FormFactoryTest {
    @Test fun testFormFactoryEmitsForm() =
        runBlocking {
    ...
    @Test fun testFormFactoryEmitsMultipleForms() =
        runBlocking {
            val channel = Channel<Form>(capacity = Channel.BUFFERED)
            val formFactory = FormFactory(this, channel, emptyList())
    ...
    @Test fun testFormFactoryEmitsTransformedForm() =
        runBlocking {
            val channel = Channel<Form>(capacity = Channel.BUFFERED)
            val formFactory =
                FormFactory(
    ...
    @Test fun testFormFactoryLaunchesActions(): Unit =
        runBlocking {
            val channel = Channel<Form>(capacity = Channel.BUFFERED)
    ...
    @Test fun testFormFactoryCancelsPreviouslyLaunchedActions(): Unit =
        runBlocking {
            val channel = Channel<Form>(capacity = Channel.BUFFERED)
    ...
    @Test fun testEmitDoesNotEmitSameFormTwice(): Unit =
        runBlocking {
            val channel = Channel<Form>(capacity = Channel.BUFFERED)
            val formFactory = FormFactory(this, channel, emptyList())
    ...
    @Test fun testFormFactorySkipsLaunchesActions(): Unit =
        runBlocking {
            val channel = Channel<Form>(capacity = Channel.BUFFERED)

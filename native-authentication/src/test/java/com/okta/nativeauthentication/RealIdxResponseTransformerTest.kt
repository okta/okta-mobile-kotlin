...
internal class RealIdxResponseTransformerTest {
    ...
    @Test fun basicFormIsReturned() {
        ...
        val formBuilder =
            RealIdxResponseTransformer().transform(noInteractionsResponseTransformer, response) { remediation, _ ->
    ...
    @Test fun nestedFormAddsOptionsElement(): Unit =
        runBlocking {
            val json =
                """
                {
    ...
    @Test fun optionElementFieldLevelError(): Unit =
        runBlocking {
            val json =
                """
                {

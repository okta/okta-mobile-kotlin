...
public final class Main implements Callable<Integer> {
  ...
  public Integer call() {
    ...
    if (xaaConfig.getIdpIssuer() != null && xaaConfig.getIdpClientId() != null) {
      ...
      xaaIdpClient = xaaIdpClientBuilder.build().getOrThrow();
      xaaIdpFlow =
    ...
    // validateConfig() prevents the console view from ever doing.
    String xaaTargetClientId = xaaConfig.getClientId() != null ? xaaConfig.getClientId() : clientId;

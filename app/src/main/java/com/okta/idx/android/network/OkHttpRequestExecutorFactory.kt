...
class OkHttpRequestExecutorFactory : RequestExecutorFactory {
    override fun create(clientConfiguration: HttpClientConfiguration): RequestExecutor {
        return RetryRequestExecutor(
            clientConfiguration,

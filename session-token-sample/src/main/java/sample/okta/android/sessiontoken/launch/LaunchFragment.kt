 ...
 */
package sample.okta.android.sessiontoken.launch
...
internal class LaunchFragment : BaseFragment<FragmentLaunchBinding>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.loginWithSessionToken.setOnClickListener {
            findNavController().navigate(LaunchFragmentDirections.launchToSessionToken())
        }
    }

...
@Preview
@Composable
private fun BrowserAuthScreenPreview() {
    DirectAuthAppTheme {
        BrowserAuthScreen(onSignIn = {}, onBack = {})
    }
}

@Preview
@Composable
private fun BrowserAuthScreenLoadingPreview() {
    DirectAuthAppTheme {
        BrowserAuthScreen(onSignIn = {}, onBack = {}, isLoading = true)
    }
}

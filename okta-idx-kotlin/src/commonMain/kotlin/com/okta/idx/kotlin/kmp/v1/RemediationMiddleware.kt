...
import com.okta.idx.kotlin.kmp.IdxAuthenticatorCollection
import com.okta.idx.kotlin.kmp.IdxCapabilityCollection
import com.okta.idx.kotlin.kmp.IdxIdpCapability
import com.okta.idx.kotlin.kmp.IdxMessageCollection
import com.okta.idx.kotlin.kmp.IdxPollRemediationCapability
import com.okta.idx.kotlin.kmp.IdxRemediation
import com.okta.idx.kotlin.kmp.IdxRemediationCollection
...
internal fun convertBase64UrltoBase64(data: String): Result<String> =
    runCatching {
        ...
        runCatching {
            val base64UrlData = Base64.UrlSafe.decode(data)
            Result.success(Base64.Default.encode(base64UrlData))
        }.getOrElse {
            Result.failure(it)
        }
    }

...
class IdxResponse internal constructor(
    ...
    /** Indicates whether the user has authenticated successfully. When `true`, retrieve the [IdxRemediation.Type.ISSUE] remediation from [remediations] and pass it to [InteractionCodeFlow.exchangeInteractionCodeForTokens] to obtain tokens. */

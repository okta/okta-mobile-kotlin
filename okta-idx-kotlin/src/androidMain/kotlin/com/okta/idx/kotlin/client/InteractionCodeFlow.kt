...
import com.okta.idx.kotlin.SDK_VERSION
...
@Deprecated(
    message =
        "The Android-only InteractionCodeFlow is deprecated in favor of the KMP variant, which works on " +
            "Android and JVM. Use com.okta.idx.kotlin.kmp.InteractionCodeFlow instead.",
    replaceWith = ReplaceWith("com.okta.idx.kotlin.kmp.InteractionCodeFlow")
)

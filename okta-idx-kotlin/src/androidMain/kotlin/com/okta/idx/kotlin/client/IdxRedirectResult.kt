...
@Deprecated(
    message =
        "The Android-only IdxRedirectResult is deprecated in favor of the KMP variant, which works on " +
            "Android and JVM. Use com.okta.idx.kotlin.kmp.IdxRedirectOutcome instead.",
    replaceWith = ReplaceWith("com.okta.idx.kotlin.kmp.IdxRedirectOutcome")
)

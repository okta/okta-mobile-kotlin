...
class InteractionCodeFlowTest {
    ...
    @Test
    fun testStartWithNoEndpoints(): Unit =
        runBlocking {
    ...
    @Test
    fun testStartWithExtraParameters(): Unit =
        runBlocking {
            networkRule.enqueue(
    ...
    @Test
    fun testProceedCopiesRemediationValues(): Unit =
        runBlocking {
            networkRule.enqueue(path("/oauth2/default/v1/interact")) { response ->
                response.testBodyFromFile("client/interactResponse.json")
            }
    ...
    @Test
    fun testExchangeCodesWithMaxAge(): Unit =
        runBlocking {
            networkRule.enqueue(path("/oauth2/default/v1/interact")) { response ->
                response.testBodyFromFile("client/interactResponse.json")
            }
    ...
    @Test
    fun testExchangeCodeWithWrongRemediationType(): Unit =
        runBlocking {
            networkRule.enqueue(path("/oauth2/default/v1/interact")) { response ->
                response.testBodyFromFile("client/interactResponse.json")
            }
    ...
    @Test
    fun testResumeWithValidNon200HttpCode(): Unit =
        runBlocking {
            networkRule.enqueue(path("/oauth2/default/v1/interact")) { response ->
                response.testBodyFromFile("client/interactResponse.json")
            }
    ...
    @Test
    fun testResumeWithInvalidHttpCode(): Unit =
        runBlocking {
            networkRule.enqueue(path("/oauth2/default/v1/interact")) { response ->
                response.testBodyFromFile("client/interactResponse.json")
            }
    ...
    @Test
    fun `resume without calling start, expect illegal state exception`() =
        runTest {
            // arrange
            val flow = InteractionCodeFlow()
    ...
    @Test
    fun `exchangeInteractionCodeForTokens without calling start, expect illegal state exception`() =
        runTest {
            // arrange
            val flow = InteractionCodeFlow()
    ...
    @Test
    fun `evaluateRedirectUri without calling start, expect illegal state exception`() =
        runTest {
            // arrange
            val flow = InteractionCodeFlow()
    ...
    @Test
    fun `proceed adds origin header when it is missing`() =
        runTest {
            // arrange
    ...
    @Test
    fun `proceed does not overwrite an existing origin header`() =
        runTest {
            // arrange
            mockkStatic("com.okta.idx.kotlin.dto.v1.RequestMiddlewareKt")
            mockkStatic("com.okta.authfoundation.client.internal.NetworkUtilsKt")

...
class DefaultIdTokenValidatorTest {
    ...
    @Test fun testValidIdTokenWithNonce(): Unit = runBlocking {
        ...
        val client = oktaRule.createOidcClient(oktaRule.createEndpoints("https://example-test.okta.com".toHttpUrl().newBuilder()))
        idTokenValidator.validate(client, createJwt(idToken), "6ccdb66d-ad56-4072-b864-7a8fe73c0ac2", null)
    }
    ...
    @Test fun testValidIdTokenWithNonceAndMaxAge(): Unit = runBlocking {
        val idToken =
            "eyJraWQiOiJGSkEwSEdOdHN1dWRhX1BsNDVKNDJrdlFxY3N1XzBDNEZnN3BiSkxYVEhZIiwiYWxnIjoiUlMyNTYifQ..Efsgp0MZ8TZ7P2Jbb04AkJMzFFU_Qe6dRWc_sl2smUxz7RGCcLuHZRSySMR_AnPPZZ5tSdar5D1SNNbqkxNaaIjXRxomQ5aqM5Y9k5cICA48cyeZ4ELqTwP2j9ko44nmUmKhyWtZjqIkL8uFbeK73KOtR9vDZJMkA75MLC23l5F2DYWtoJXZg8QD1SzFNfsvxj3w6sEKo0yivEBH1-iMbJiXbkCIwzuS8APpBAMvXQGp1GJXnK2i-1DbHxgr_DEOKIQqSnOXpVjzxibXqUR0LEXKda-f7tW_3W308vIN18J3WN_yFfkB9e2gDYPVhmGt-EPtT2JCjfgzOsJmzxWV-g"
        val client = oktaRule.createOidcClient(oktaRule.createEndpoints("https://example-test.okta.com".toHttpUrl().newBuilder()))
        idTokenValidator.validate(client, createJwt(idToken), "6ccdb66d-ad56-4072-b864-7a8fe73c0ac2", 300)
    }
    ...
    @Test fun testNullAuthTime() {
        val idToken =
            "eyJraWQiOiJGSkEwSEdOdHN1dWRhX1BsNDVKNDJrdlFxY3N1XzBDNEZnN3BiSkxYVEhZIiwiYWxnIjoiUlMyNTYifQ..ribaaMqxWTJEtWVmP7TjzJyRveUZvX6idLP-JFKG5i6kkgfuU8a7XQ7Wyueg_nQ2AF2I79W-kxBMi8unNqm-MpRuah-YyJvIAodAVkA_rXSCHhAAqlrYxvmMZhX5P5dMjvXpuPTlXMLz7Ick3HU14NwvKHbAbsY5dW5a6leY3Wd1yUsNQhrq2yhEm0iwsn2c5igV5H03fPD3G5KEFRkdQGA_FWQ7klTqdUyF4QGiGfm_589ulIW6J1tfZGduKJno2-2o7GlqdeCV5d3CoIdoQ9XIx3SoIqzfSy0wUJRXezok190JTSBng_qXfW3TjHsMDHsrkFlFGirl3f4yzJtZag"
        assertFailsWithMessage(
    ...
    @Test fun testNegativeMaxAge() {
        val idToken =
            "eyJraWQiOiJGSkEwSEdOdHN1dWRhX1BsNDVKNDJrdlFxY3N1XzBDNEZnN3BiSkxYVEhZIiwiYWxnIjoiUlMyNTYifQ..jcPxuVXABCymkiUuPPvIh57l9VXBpOaUdOcy8yz2_8VecAWYS5hYIxog-vPzgpLdkJ4GY5uIEZH69F9o85Ki2Zq7QdBPbOKroDdZIOUPSsG7Z9HlsQs6XlbN0KpqNhTlBdFMIfBT8I55cl0USsMECKD6Zwn03X7N7l5pviTCs0ZECEUmOIVPtQtgO15EQZne_r0qWoLMsLiKbaYrVjzfhxyIzD9NGfyjbxXlIsvTg5eup-efJayl_FAAEr7WF_gj-9aR8-3PllYsbyGFEpMg0OBMUZEtQPZpPFnHdq3-ef2MPY0rSgBFMKgxh7mjI2YiUpU56sMG61mPrlq-_ZLI4w"
        assertFailsWithMessage(
    ...
    @Test fun testOutsideOfRangeMaxAge() {
        val idToken =
            "eyJraWQiOiJGSkEwSEdOdHN1dWRhX1BsNDVKNDJrdlFxY3N1XzBDNEZnN3BiSkxYVEhZIiwiYWxnIjoiUlMyNTYifQ..TIiAGZe1hEOeYx5EFMjYT1rQUC-TEIF_tlNlk4gg5Og9QQ3dAvyLTiJhDRAhQkr2rm_l-j3lPUgfC2-VQsiJ9nTsekCuxu7Crc2OXwWUd3dVfnFPKqfV6h-gvxfBfFhhX-_OJZ6EU4uzFCe-Za8AscYmsoaKM0-4lrdZsqTzmP9HvkWvVtBi6e3jeiLV3gj9K21S1kiqS6MJK5-mULWw8mDmPkltNyU06pQGxMg8AcFE2n8H64HVA71vdUISfu2wgW-neFFuXaEWVhHxXLobXoIwn71J-j2BqzAXXYFyyUozouCNUxoIwbCzqimHHSLCj7ks2t61eEF13IqCZ_2Itg"
        assertFailsWithMessage(
            "Max age not satisfied.",
            idToken,
            maxAge = 300,
    ...
    private fun assertFailsWithMessage(message: String, idToken: String, issuerPrefix: String = "https", nonce: String? = null, maxAge: Int? = null) {
        try {
            val client = oktaRule.createOidcClient(oktaRule.createEndpoints("$issuerPrefix://example-test.okta.com".toHttpUrl().newBuilder()))
            runBlocking { idTokenValidator.validate(client, createJwt(idToken), nonce, maxAge) }
            fail()

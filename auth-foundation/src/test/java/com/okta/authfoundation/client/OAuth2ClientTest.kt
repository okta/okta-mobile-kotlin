...
class OAuth2ClientTest {
    ...
    @Test
    fun testCreateNetworkFailure(): Unit =
        runBlocking {
            ...
            assertThat(errorResult.exception)
                .hasMessageThat()
                .isEqualTo("HTTP Error: status code - 503")
        }

    @Test
    fun testGetUserInfo(): Unit =
        runBlocking {
            oktaRule.enqueue(
                method("GET"),
    ...
    @Test
    fun testGetUserInfoFailsWithNoSub(): Unit =
        runBlocking {
            oktaRule.enqueue(
                method("GET"),
                path("/oauth2/default/v1/userinfo"),
    ...
    @Test
    fun testGetUserInfoFailure(): Unit =
        runBlocking {
            oktaRule.enqueue(
                path("/oauth2/default/v1/userinfo")
            ) { response ->
    ...
    @Test
    fun testRefreshTokenEmitsEvent(): Unit =
        runBlocking {
            oktaRule.enqueue(
                method("POST"),
                header("content-type", "application/x-www-form-urlencoded"),
    ...
    @Test
    fun testRefreshTokenFailure(): Unit =
        runBlocking {
            oktaRule.enqueue(
                path("/oauth2/default/v1/token")
            ) { response ->
    ...
    fun testRevokeToken(): Unit =
        runBlocking {
            ...
            val result =
                oktaRule.createOAuth2Client().revokeToken(
    ...
    @Test
    fun testRevokeTokenFailure(): Unit =
        runBlocking {
            oktaRule.enqueue(
                path("/oauth2/default/v1/revoke")
            ) { response ->
    ...
    @Test
    fun testIntrospectActiveAccessToken(): Unit =
        runBlocking {
            oktaRule.enqueue(
                method("POST"),
                header("content-type", "application/x-www-form-urlencoded"),
            ...
            val result =
                oktaRule.createOAuth2Client().introspectToken(
    ...
    @Test
    fun testIntrospectInactiveAccessToken(): Unit =
        runBlocking {
            oktaRule.enqueue(
                method("POST"),
                header("content-type", "application/x-www-form-urlencoded"),
    ...
    @Test
    fun testIntrospectActiveRefreshToken(): Unit =
        runBlocking {
            oktaRule.enqueue(
                method("POST"),
                header("content-type", "application/x-www-form-urlencoded"),
    ...
    @Test
    fun testIntrospectActiveIdToken(): Unit =
        runBlocking {
            oktaRule.enqueue(
                method("POST"),
                header("content-type", "application/x-www-form-urlencoded"),
    ...
    @Test
    fun testIntrospectActiveDeviceSecret(): Unit =
        runBlocking {
            oktaRule.enqueue(
                method("POST"),
                header("content-type", "application/x-www-form-urlencoded"),
    ...
    @Test
    fun testIntrospectWithNoActiveField(): Unit =
        runBlocking {
            oktaRule.enqueue(
                method("POST"),
                header("content-type", "application/x-www-form-urlencoded"),
    ...
    @Test
    fun testIntrospectFailure(): Unit =
        runBlocking {
            oktaRule.enqueue(
                path("/oauth2/default/v1/introspect")
            ) { response ->
    ...
    @Test
    fun testJwksIsNotCachedWhenTheRequestFails(): Unit =
        runBlocking {
            oktaRule.enqueue(
                path("/oauth2/default/v1/keys")
            ) { response ->
    ...
    @Test
    fun testRefreshTokenValidationWithJwks(): Unit =
        runBlocking {
            val client = oktaRule.createOAuth2Client(oktaRule.createEndpoints(includeJwks = true))
            oktaRule.enqueue(
                path("/oauth2/default/v1/keys")
    ...
    @Test
    fun testRefreshTokenValidationFailsWithJwksError(): Unit =
        runBlocking {
            val client = oktaRule.createOAuth2Client(oktaRule.createEndpoints(includeJwks = true))
            oktaRule.enqueue(
                path("/oauth2/default/v1/keys")
    ...
    @Test
    fun testRefreshTokenValidationFailsWithInvalidSignature(): Unit =
        runBlocking {
            val client = oktaRule.createOAuth2Client(oktaRule.createEndpoints(includeJwks = true))
            oktaRule.enqueue(
                path("/oauth2/default/v1/keys")

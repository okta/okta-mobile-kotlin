...
class JwtParserTest {
    ...
    @Test fun testJwtParserCreate(): Unit =
        runBlocking {
            val input =
                oktaRule
                    .createOAuth2Client()
    ...
    @Test fun testJwtParserMalformed(): Unit =
        runBlocking {
            val validInput =
                oktaRule
                    .createOAuth2Client()
    ...
    @Test fun testJwtInstancesAreEqual(): Unit =
        runBlocking {
            val input =
                oktaRule
                    .createOAuth2Client()
    ...
    @Test fun testJwtParserNonBase64Header(): Unit =
        runBlocking {
            val validInput =
                oktaRule
                    .createOAuth2Client()
    ...
    @Test fun testJwtParserNonBase64Claims(): Unit =
        runBlocking {
            val validInput =
                oktaRule
                    .createOAuth2Client()
